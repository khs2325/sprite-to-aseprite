...
| PNG sequence | A tested flattened frame compositor, frame order, canvas size, visible layer compositing, cel offsets | Exports pixels only; layer names, tags, palettes, and editor metadata are not preserved. |
